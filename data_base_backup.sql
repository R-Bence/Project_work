...
CREATE TABLE `base_conn_order` (
  ...
  CONSTRAINT `conn_base` FOREIGN KEY (`product_id`) REFERENCES `base` (`base_id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `conn_order` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`) ON DELETE CASCADE ON UPDATE RESTRICT
...
INSERT INTO `orders` VALUES (1,1,'2024-02-22','5310, Kisújszállás, Marjalaki utca 10'),(2,1,'2024-02-22','5310, Kisújszállás, Marjalaki utca 10'),(3,1,'2024-02-22','5310, Kisújszállás, Marjalaki utca 10');
...
CREATE TABLE `users` (
  ...
  `user_addres` varchar(100) COLLATE utf8mb3_hungarian_ci DEFAULT NULL,
  PRIMARY KEY (`user_id`),
...
INSERT INTO `users` VALUES (1,'Kovács Béla','kovacsbela@gmail.hu',0,1,'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3','1016, Budapest, Aladár utca 10'),(2,'Kis Pista','kispista@gmail.hu',0,1,'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3','1016, Budapest, Aladár utca 10'),(4,'admin','admin@gmail.com',0,3,'8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918','');
...
-- Dump completed on 2024-03-13 12:19:35
